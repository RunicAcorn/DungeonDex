...
namespace API.Migrations
{
    ...
    [Migration("20240518150402_UsingListNotArrayInitializer")]
    partial class UsingListNotArrayInitializer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Chapter", b =>
                {
            ...
            modelBuilder.Entity("API.Combat", b =>
                {
                    b.HasBaseType("API.Scene");

                    b.Property<string>("combatLog")
                        .HasColumnType("nvarchar(max)");

                    b.HasDiscriminator().HasValue("Combat");
                });

            modelBuilder.Entity("API.Dialogue", b =>
                {
                    b.HasBaseType("API.Scene");
            ...
            modelBuilder.Entity("API.Narrative", b =>
                {
                    b.HasBaseType("API.Scene");
                    ...
                    b.HasDiscriminator().HasValue("Narrative");
                });
            ...
            modelBuilder.Entity("API.Monster", b =>
                {
                    ...
                    b.HasOne("API.Combat", null)
                        .WithMany("monstersToFight")
            ...
            modelBuilder.Entity("API.Combat", b =>
                {
                    b.Navigation("monstersToFight");

                    b.Navigation("playersInCombat");
                });
